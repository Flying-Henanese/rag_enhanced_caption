...
![HKUDS RAG-Anything](https://user-images.githubusercontent.com/74038190/212284100-561aa473-3905-4a80-b561-0d28506553ee.gif)
![LiteWrite](https://raw.githubusercontent.com/HKUDS/RAG-Anything/main/assets/LiteWrite.png) [🚀 LiteWrite-AI 原生 LaTeX 编辑器](https://litewrite.ai)

---

## 🚀 RAG-Anything: All-in-One RAG System|🎉 新闻
...
## 🚀 RAG-Anything: All-in-One RAG System|🌟 系统概述

*下一代多模态智能*
**RAG-Anything**是一个综合性多模态文档处理RAG system。该系统能够无缝处理和查询包含文本、图像、表格、公式等多模态内容的复杂文档，提供完整的检索增强(RAG)生成解决方案。
...
<image_analysis>
- **核心总结**: This diagram visually outlines the core architecture of the RAG-Anything framework, illustrating how diverse input documents (like PPT, DOC, JPG, PDF) are processed through a multi-stage pipeline. It demonstrates the system's ability to parse multi-modal content, ground it into a unified knowledge graph, store it in a vector database, and finally retrieve and synthesize information to answer user queries. The image serves as a structural overview, showing the flow from raw data ingestion to final response generation, thereby illustrating the system's comprehensive, end-to-end design.
- **关键实体**: rag_anything_framework
- **简短摘要**: Illustrates the end-to-end architecture of the RAG-Anything system, showing how multi-modal documents are parsed, grounded into a knowledge graph, stored in a vector database, and used to answer user queries.
</image_analysis>
</details>
...
### 🚀 RAG-Anything: All-in-One RAG System|🌟 系统概述|🎯 核心特性
...
## 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构

<div style="background: linear-gradient(135deg, #0f0f23 0%, #1a1a2e 100%); border-radius: 15px; padding: 25px; margin: 20px 0; border-left: 5px solid #00d9ff;">

---

### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|核心算法
...
### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|1. 文档解析阶段
...
### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|2. 多模态内容理解与处理
...
### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|3. 多模态分析引擎
...
### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|4. 多模态知识图谱索引
...
### 🚀 RAG-Anything: All-in-One RAG System|🏗️ 算法原理与架构|5. 模态感知检索
...
## 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|安装|选项1：从PyPI安装（推荐）
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|安装|选项2：从源码安装
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|安装|可选依赖
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|1. 端到端文档处理
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|2. 直接多模态内容处理
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|3. 批量处理
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|4. 自定义模态处理器
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|5. 查询选项
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|6. 加载已存在的LightRAG实例
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 1
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 2
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 3
# 创建 RAGAnything 配置
    config = RAGAnythingConfig(
        working_dir="./rag_storage",
        enable_image_processing=True,
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 4
# 定义模型函数
    def llm_model_func(prompt, system_prompt=None, history_messages=[], **kwargs):
        return openai_complete_if_cache(
            "gpt-4o-mini",
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 5
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 6
embedding_func = EmbeddingFunc(
        embedding_dim=3072,
        max_token_size=8192,
        func=partial(
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 7
# 初始化 RAGAnything
    rag = RAGAnything(
        config=config,
        llm_model_func=llm_model_func,
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 8
# 示例：来自外部源的预解析内容列表
    content_list = [
        {
            "type": "text",
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 9
# 直接插入内容列表
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 10
# 查询插入的内容
    result = await rag.aquery(
        "研究中提到的主要发现和性能指标是什么？",
        mode="hybrid"
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 11
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 12
await rag.insert_content_list(
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 13
if __name__ == "__main__":
    asyncio.run(insert_content_list_example())

---

#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表|Part 14
```
**内容列表格式：**
...
#### 🚀 RAG-Anything: All-in-One RAG System|🚀 快速开始|使用示例|7. 直接插入内容列表
...
## 🚀 RAG-Anything: All-in-One RAG System|🛠️ 示例
...
## 🚀 RAG-Anything: All-in-One RAG System|🔧 配置

*系统优化参数*

---

### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|环境变量
...
### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|解析器配置

RAGAnything 现在支持多种解析器，每种解析器都有其特定的优势：

---

#### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|解析器配置|MinerU 解析器
...
#### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|解析器配置|Docling 解析器
...
### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|MinerU配置
...
### 🚀 RAG-Anything: All-in-One RAG System|🔧 配置|处理要求
...
### 🚀 RAG-Anything: All-in-One RAG System|🧪 支持的内容类型|文档格式
...
### 🚀 RAG-Anything: All-in-One RAG System|🧪 支持的内容类型|多模态元素
...
## 🚀 RAG-Anything: All-in-One RAG System|📖 引用
...
## 🚀 RAG-Anything: All-in-One RAG System|🔗 相关项目
...
## 🚀 RAG-Anything: All-in-One RAG System|⭐ Star History
...
## 🚀 RAG-Anything: All-in-One RAG System|🤝 贡献者
